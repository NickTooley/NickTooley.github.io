...
I formatted the date shown in lecturer and student landings to display in a more user friendly and less cluttered manner. I also added onto one of my previous sprint tasks which was displaying all the students to the lecturer and their remaining leave days per type. I modified this to only display students in streams the lecturer teaches and also the ability to display students in a stream selected from a dropdown menu.<br /><br />
